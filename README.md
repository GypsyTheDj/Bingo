...
### <h3 align= "center">A Simple Memory Android Game powered by Google's Firebase</h2>
...
1. Clone forked repository `git clone git@github.com:YOUR-USERNAME/Bingo.git`

All changes should be based from the `master` branch. Push to your fork and [submit a pull request](https://github.com/GypsyTheDj/Bingo/pulls) against the `master` branch.
